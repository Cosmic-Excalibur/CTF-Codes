...
class ECC_Hash_Cracker:
    def __init__(self, a, b, blocksize):
        ...
        self.modpoly = lambda y: self.Fp2x.gen()^3+y^3-self.Fp2x.gen()^2*y^2+1488*(self.Fp2x.gen()^2*y+self.Fp2x.gen()*y^2)-162000*(self.Fp2x.gen()^2+y^2)+40773375*self.Fp2x.gen()*y+8748000000*(self.Fp2x.gen()+y)-157464000000000
    ...
    def next_j(self, j, i, exclude = None, mode = 0):
        ...
        candidates = [r[0] for r in self.modpoly(j).roots()]
